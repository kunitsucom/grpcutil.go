...
type registerHandler = func(ctx context.Context, mux *gw_runtime.ServeMux, conn *grpc.ClientConn, opts []grpc.DialOption) (err error)

func RegisterHandlers(ctx context.Context, mux *gw_runtime.ServeMux, conn *grpc.ClientConn, opts []grpc.DialOption, handlers ...registerHandler) error {
	for _, handler := range handlers {
		if err := handler(ctx, mux, conn, opts); err != nil {
